...
HEADLINES: Dict[str, List[str]] = {
    ...
    "nuclear_reactors": ["status", "source_id", "website"],
    "lng_terminals": ["type", "capacity_mmcfd", "operator", "owner", "status"],
    "gas_storage": ["type", "capacity_mmcfd", "operator", "status"],
    "biodiesel_plants": ["capacity_mgy", "operator", "status"],
    "levees": ["name", "operator", "source_id"],
    "leveed_areas": ["name", "source_id"],
    "water_service_areas": ["population_served", "type", "source_id"],
    "water_wells": ["type", "operator", "status"],
    "reservoirs": ["type", "capacity_mwh", "operator"],
    "urgent_care": ["type", "phone", "address", "status"],
    "service_territories": ["owner", "type", "operator"],
    "rto_regions": ["type", "operator"],
    "heliports": ["type", "elevation_ft", "owner", "source_id"],
    "broadcast_towers": ["height_ft", "structure_type", "owner", "source_id"],
    "telecom_exchanges": ["operator", "type", "address"],
    "fuel_stations": ["type", "operator", "address"],
    "industrial": ["type", "operator", "status"],
    ...
    "agri_facilities": ["type", "operator", "address"],
    "livestock_operations": ["type", "operator"],
    "mines": ["substance", "type", "operator", "owner", "status"],
    "state_boundary": ["name", "type"],
    "county_boundary": ["name", "type"],
    "city_boundaries": ["name", "type"],
}
